...
def add(arguments: list[int], registers: list[int]):
    ...
    logging.debug(
        f"{registers[4] - ISA.ADD.number_of_arguments} {ISA.ADD.name} ->"
...
def sub(arguments: list[int], registers: list[int]):
    ...
    logging.debug(
        f"{registers[4] - ISA.SUB.number_of_arguments} {ISA.SUB.name} -> "
        f"{get_register_name_by_index(arguments[0])} - {get_register_name_by_index(arguments[1])}"
    )
...
def mul(arguments: list[int], registers: list[int]):
    ...
    logging.debug(
        f"{registers[4] - ISA.MUL.number_of_arguments} {ISA.MUL.name} -> "
        f"{get_register_name_by_index(arguments[0])} * {get_register_name_by_index(arguments[1])}"
    )
...
def idiv(arguments: list[int], registers: list[int]):
    ...
    logging.debug(
        f"{registers[4] - ISA.IDIV.number_of_arguments} {ISA.IDIV.name} -> "
        f"{get_register_name_by_index(arguments[0])}  / {get_register_name_by_index(arguments[1])}"
    )
...
def and_command(arguments: list[int], registers: list[int]):
    ...
    logging.debug(
        f"{registers[4] - ISA.AND.number_of_arguments} {ISA.AND.name} -> "
        f"{get_register_name_by_index(arguments[0])}  & {get_register_name_by_index(arguments[1])}"
    )
...
def or_command(arguments: list[int], registers: list[int]):
    ...
    logging.debug(
        f"{registers[4] - ISA.OR.number_of_arguments} {ISA.OR.name} -> "
        f"{get_register_name_by_index(arguments[0])}  | {get_register_name_by_index(arguments[1])}"
    )
...
def xor(arguments: list[int], registers: list[int]):
    ...
    logging.debug(
        f"{registers[4] - ISA.XOR.number_of_arguments} {ISA.XOR.name} -> "
        f"{get_register_name_by_index(arguments[0])}  ^ {get_register_name_by_index(arguments[1])}"
    )
...
def inc(arguments: list[int], registers: list[int]):
    ...
    logging.debug(
        f"{registers[4] - ISA.INC.number_of_arguments} {ISA.INC.name} -> "
...
def neg(arguments: list[int], registers: list[int]):
    ...
    logging.debug(
        f"{registers[4] - ISA.NEG.number_of_arguments} {ISA.NEG.name} -> "
...
def eq(arguments: list[int], registers: list[int]):
    ...
    logging.debug(
        f"{registers[4] - ISA.EQ.number_of_arguments} {ISA.EQ.name} -> "
        f"{get_register_name_by_index(arguments[0])} = {get_register_name_by_index(arguments[1])}"
    )
...
def neq(arguments: list[int], registers: list[int]):
    ...
    logging.debug(
        f"{registers[4] - ISA.NEQ.number_of_arguments} {ISA.NEQ.name} -> "
        f"{get_register_name_by_index(arguments[0])} != {get_register_name_by_index(arguments[1])}"
    )
...
def gr(arguments: list[int], registers: list[int]):
    ...
    logging.debug(
        f"{registers[4] - ISA.GR.number_of_arguments} {ISA.GR.name} -> "
        f"{get_register_name_by_index(arguments[0])} > {get_register_name_by_index(arguments[1])}"
    )
...
def greq(arguments: list[int], registers: list[int]):
    ...
    logging.debug(
        f"{registers[4] - ISA.GREQ.number_of_arguments} {ISA.GREQ.name} -> "
        f"{get_register_name_by_index(arguments[0])} >= {get_register_name_by_index(arguments[1])}"
    )
...
def ls(arguments: list[int], registers: list[int]):
    ...
    logging.debug(
        f"{registers[4] - ISA.LS.number_of_arguments} {ISA.LS.name} -> "
        f"{get_register_name_by_index(arguments[0])}  < {get_register_name_by_index(arguments[1])}"
    )
...
def lseq(arguments: list[int], registers: list[int]):
    ...
    logging.debug(
        f"{registers[4] - ISA.LSEQ.number_of_arguments} {ISA.LSEQ.name} -> "
        f"{get_register_name_by_index(arguments[0])} <= {get_register_name_by_index(arguments[1])}"
    )
...
def push(arguments: list[int], registers: list[int]):
    ...
    logging.debug(
        f"{registers[4] - ISA.PUSH.number_of_arguments} {ISA.PUSH.name} -> "
        f"{get_register_name_by_index(arguments[0])}"
    )
...
def sv(arguments: list[int], registers: list[int]):
    ...
    logging.debug(
        f"{registers[4] - ISA.SV.number_of_arguments} {ISA.SV.name} -> "
        f"{get_register_name_by_index(arguments[0])} {get_register_name_by_index(arguments[1])}"
    )
...
def ldc(arguments: list[int], registers: list[int]):
    ...
    logging.debug(
        f"{registers[4] - ISA.LDC.number_of_arguments} {ISA.LDC.name} -> "
...
def ld(arguments: list[int], registers: list[int]):
    ...
    logging.debug(
        f"{registers[4] - ISA.LD.number_of_arguments} {ISA.LD.name} -> "
        f"{get_register_name_by_index(arguments[0])} {get_register_name_by_index(arguments[1])}"
    )
...
def mov(arguments: list[int], registers: list[int]):
    ...
    logging.debug(
        f"{registers[4] - ISA.MOV.number_of_arguments} {ISA.MOV.name} -> "
        f"{get_register_name_by_index(arguments[0])} {get_register_name_by_index(arguments[1])}"
    )
...
def call(cpu, arguments: list[int], registers: list[int]):
    ...
    logging.debug(
        f"{registers[4] - ISA.CALL.number_of_arguments} {ISA.CALL.name} -> "
        f"{get_register_name_by_index(arguments[0])}"
    )
...
def brmn(arguments: list[int], registers: list[int]):
    ...
    logging.debug(
        f"{registers[4] - ISA.BRMN.number_of_arguments} {ISA.BRMN.name} -> "
        f"{get_register_name_by_index(arguments[0])} {get_register_name_by_index(arguments[1])}"
    )
...
def jmp(arguments: list[int], registers: list[int]):
    ...
    logging.debug(
        f"{registers[4] - ISA.JMP.number_of_arguments} {ISA.JMP.name} -> " f"{get_register_name_by_index(arguments[0])}"
    )
...
def brpl(arguments: list[int], registers: list[int]):
    ...
    if arg > 0:
        ...
        logging.debug(
            f"{registers[4] - ISA.BRPL.number_of_arguments} {ISA.BRPL.name} -> "
            f"{get_register_name_by_index(arguments[0])}"
        )
...
def mod(arguments: list[int], registers: list[int]):
    ...
    logging.debug(
        f"{registers[4] - ISA.MOD.number_of_arguments} {ISA.MOD.name} -> "
        f"{get_register_name_by_index(arguments[0])} % {get_register_name_by_index(arguments[1])}"
    )
...
def prt(arguments: list[int], registers: list[int]):
    ...
    logging.debug(
        f"{registers[4] - ISA.PRT.number_of_arguments} {ISA.PRT.name} -> "
        f"{get_register_name_by_index(arguments[0])} {get_register_name_by_index(arguments[1])}"
    )
...
def rdl(arguments: list[int], registers: list[int]):
    ...
    logging.debug(
        f"{registers[4] - ISA.RDL.number_of_arguments} {ISA.RDL.name} -> " f"{get_register_name_by_index(arguments[0])}"
    )
